...
- Grabs the latest Magic Lantern build and loads it onto your card
- Shows you what to do on the camera itself, with short videos showing the process
- Quick Mode if you already know what you're doing and just want it done quick :)

## Getting a "can't be opened" error?

**Mac:** you'll probably see something like "Magic Lantern Installer can't be opened". It's not signed with a paid Apple developer certificate yet, so Gatekeeper blocks it the first time. Easy fix:
...
Massive thanks to Bilal, Danne, and Amit for building these out for the EOS M, and to the [Magic Lantern](https://www.magiclantern.fm/) team for the firmware itself - none of this could exist without their work.

### License

Magic Lantern (and every build listed here) is licensed under **[GNU GPL v2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)**. Each build's own repo/thread above is where the actual source lives. This installer is a separate tool - it just downloads and copies those builds onto your card, it doesn't modify or redistribute modified Magic Lantern source.
