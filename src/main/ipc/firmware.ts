...
import { MAX_DRIVE_SIZE_GB, MAX_DRIVE_SIZE_GB_OVERRIDE, FAKE_DRIVE_ID } from '@shared/diskTypes'
...
export function registerFirmwareIpc(ipcMain: IpcMain): void {
  ipcMain.handle('firmware:installToDrive', async (event, deviceId: string, override?: boolean): Promise<CopyResult> => {
